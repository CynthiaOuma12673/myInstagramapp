...
from .forms import NewsLetterForm, UpdateUserForm, UpdateUserProfileForm, UserRegistrationForm,PostForm,CommentForm
...
def index(request):
    ...
    if request.method == 'POST':
        ...
        post_form = PostForm()
    return render(request, 'all-ig/home.html',{'posts': posts,'post_form': post_form,'all_users': all_users,'comments':comments,'current_user':current_user} )
